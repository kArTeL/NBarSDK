Pod::Spec.new do |s|
  ...
  # Keep existing mapping so imports like <NBarSDK/ZBarReaderView.h> continue to work
  s.public_header_files = ['iphone/*.h', 'iphone/**/**/*.h', 'include/*.h']

  # Precisely include sources to avoid overlapping/duplicate matches
  s.source_files = [
    "include/zbar.h",
    # Headers required for compilation (kept private below)
    "zbar/**/*.h",
    "iphone/*.h",
    "iphone/include/**/*.h",
    # Sources
